...
namespace Flowers.State
{
    ...
    public class FlowerStateMachine : StateMachineMB
    {
        ...
        private void Awake()
        {
            ...
            GrowState = new FlowerGrowState(this, _flowerRenderer, _flowerMaterial);
        ...
        private void OnParticleCollision(GameObject gameObject)
        {
            ...
            if (currentState == UnseededState && gameObject.name == "Particles_Seeds")
            {
            ...
            if (currentState == SeededState && gameObject.name == "Particles_Water")
            {
        ...
        void OnCollisionExit(Collision collision)
        {
            ...
            {
                // Change State to "Unseeded State" once Collision with Trowel has occured and current State is "Withered".
